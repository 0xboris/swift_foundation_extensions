//
//  NSPredicate+KeyPath.swift
//  
//
//  Created by Boris Gutic on 20.07.22.
//
...
public func == <Value: Equatable, Root>(kp: KeyPath<Root, Value>, value: Value) -> ComparisonPredicate<Root> {
    ComparisonPredicate(kp, .equalTo, value)
}

public func != <Value: Equatable, Root, K: KeyPath<Root, Value>>(kp: K, value: Value) -> ComparisonPredicate<Root> {
    ComparisonPredicate(kp, .notEqualTo, value)
}

public func > <Value: Comparable, Root, K: KeyPath<Root, Value>>(kp: K, value: Value) -> ComparisonPredicate<Root> {
